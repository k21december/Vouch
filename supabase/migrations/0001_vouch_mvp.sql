-- Vouch MVP Schema Migration
-- Adds: candidate_profiles, referrer_profiles, matches, decisions, events
...
-- Referrers can view candidate_profiles only if a match links them
...
-- Only service role can insert matches (no RLS insert policy for anon/authenticated)
